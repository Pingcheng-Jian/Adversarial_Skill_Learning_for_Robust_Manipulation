...
<mujoco>
    ...
    <include file="single_shared.xml"></include>
    <asset>
        {assets}
    </asset>
    <worldbody>
        ...
        <include file="single_robot.xml"></include>
        ...
        <body name="object1" pos="1.31 0.75 0.45">
            <joint axis="0 1 0" name="object1:joint" armature="1" pos="1.28 0.75 0.45" limited="true" range="-0.23 0.23" damping="500" type="slide"></joint>
...
def generate_with_slide_door_xml(num_blocks):
