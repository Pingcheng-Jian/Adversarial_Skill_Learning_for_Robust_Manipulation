...
<mujoco>
    ...
    <include file="multi_shared.xml"></include>
    <asset>
        {assets}
    </asset>
    <worldbody>
        ...
        <include file="multi_robot.xml"></include>
    ...
    <actuator>
        ...
        <position ctrllimited="true" ctrlrange="0 0.2" joint="robot2:l_gripper_finger_joint" kp="30000" name="robot2:l_gripper_finger_joint" user="1"></position>
        <position ctrllimited="true" ctrlrange="0 0.2" joint="robot2:r_gripper_finger_joint" kp="30000" name="robot2:r_gripper_finger_joint" user="1"></position>
        <position ctrllimited="true" ctrlrange="0 0.2" joint="robot3:l_gripper_finger_joint" kp="30000" name="robot3:l_gripper_finger_joint" user="1"></position>
        <position ctrllimited="true" ctrlrange="0 0.2" joint="robot3:r_gripper_finger_joint" kp="30000" name="robot3:r_gripper_finger_joint" user="1"></position>
    </actuator>
</mujoco>
        '''


def generate_multi_xml(num_blocks):
    ...
    block_base = '''<body name="object{id}" pos="0.025 0.025 0.025">
            ...
            <site name="object{id}" pos="0 0 0" size="0.02 0.02 0.02" rgba="{color} 2" type="sphere"></site>
        </body>'''
