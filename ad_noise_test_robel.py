...
if args.po_agent == 'robust':
    ...
    po_agent.load_model('saved_models/robel/normal-sac/Normal_sac_actor_DClawTurnFixed-v0_-1-123456autotune', 'saved_models/robel/normal-sac/Normal_sac_critic_DClawTurnFixed-v0_-1-123456autotune')
else:
...
# po_agent.load_model('models/po_sac_actor_DClawTurnFixed-v0_protagonist121autotune', 'models/po_sac_critic_DClawTurnFixed-v0_protagonist121autotune')
...
for ite in range(1):
    ...
    for episode in range(episodes):
        ...
        # print(angle_list)
        # np.save('saved_robel_angle/' + args.po_agent + '_rand_ad'+str(args.ad_factor)+'_' + str(episode) + '.npy',
        #     np.array(angle_list))
        avg_reward /= episodes
        print(po_action_list)
        print(ad_action_list)
        print(avg_reward)
        np.save('saved_robel_action/normsVSrand_po_action_ad08_2', po_action_list)
        np.save('saved_robel_action/normVSrand_ad_action_ad08_2', ad_action_list)
...
# np.save('saved_robel_reward/robust_vs_random_0_005_135', reward_list)
