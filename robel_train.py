...
#Tesnorboard
writer = SummaryWriter('runs/{}_SAC_{}_{}_{}_{}'.format(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"),
                                                     args.env_name,
                                                     args.policy,
...
for i_episode in itertools.count(1):
    ...
    if i_episode % 10 == 0 and args.eval is True:
        ...
        print("----------------------------------------")
    if i_episode % 1000 == 0:
        agent.save_model(args.env_name, suffix=str(args.seed) + "1023autotune" if args.automatic_entropy_tuning else "")
